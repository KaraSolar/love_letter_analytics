...
WITH casted_datatypes AS (
    ...
    SELECT
        ...
        ,CAST(SAFE_CAST(telemetryLatitude1 AS NUMERIC) AS INT64) AS latitude_1
        ,CAST(SAFE_CAST(telemetryLatitude2 AS NUMERIC) AS INT64) AS latitude_2
        ,CAST(SAFE_CAST(telemetryLongitude1 AS NUMERIC) AS INT64) AS longitude_1
        ,CAST(SAFE_CAST(telemetryLongitude2 AS NUMERIC) AS INT64) AS longitude_2
